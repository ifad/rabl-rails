# RABL for Rails [![Build Status](https://travis-ci.org/ccocchi/rabl-rails.png?branch=master)](https://travis-ci.org/ccocchi/rabl-rails) [![Coverage Status](https://coveralls.io/repos/ifad/rabl-rails/badge.png?branch=master)](https://coveralls.io/r/ifad/rabl-rails?branch=master)
